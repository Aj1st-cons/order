...
function showLocationServicesPopup() {
    ...
    messageText.innerHTML = "<strong style='color: red;'>Unable to get your location</strong><br><span style='font-size:8px;'>Please check your location services in device settings.</span>";
