...
function showLocationServicesPopup() {
    ...
    // Error message with bold and red color
    let messageText = document.createElement("p");
    messageText.innerHTML = "<strong>Unable to get your location</strong><br><span style='font-size:12px;'>Please check your location services in device settings.</span>";
